...
class SuccessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Transaction done successfully.')),
      ...
      body: Center(
        child: Column(
            ...
            children: [
              const Text('Thank you for buying!'),
              SizedBox(
                height: 10,
              ),
              ElevatedButton(
...
class CancelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Center(child: Text('Transaction was unsuccessfully.')),
        automaticallyImplyLeading: false,
      ),
      body: Center(
        child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              const Text('Your transaction was canceled.'),
              SizedBox(
                height: 10,
              ),
              ElevatedButton(
